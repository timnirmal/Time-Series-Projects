...
#============================================ 1. Prepare Data according to AirPassenger.py
...
############ TODO: Unable to install pmdarima, it might work with pyhotn 3.7. Need to check
"""
...
# We got best model as the SARIMAX(0, 1, 1)x(2, 1, [], 12)
...
# Fit Best Model with Train Data
from statsmodels.tsa.statespace.sarimax import SARIMAX

model = SARIMAX(X_train['#Passengers'], order=(0, 1, 1), seasonal_order=(2, 1, 0, 12))
